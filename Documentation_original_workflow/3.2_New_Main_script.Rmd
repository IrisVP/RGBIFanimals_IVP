...
/!\ Set filename if you use another directory/filename
...
process_species_location <- function(species_name, location_name) {
  ...
  if (file.exists(filename_occ) == TRUE) {
    ...
    res <- occ_data(scientificName = species_name, hasCoordinate = TRUE, limit = 100000) # set limit to preference (but < 20000)
