...
- the sea_dist is calculated and if there's an error, this error is caught and an error_message is saved in a list called error_messages (already made before the function)
